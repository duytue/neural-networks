...
def train_model(model, train_input, train_target, batch_size, epochs, test_input, test_target):
    ...
    for e in range(epochs):
        ...
        nb = compute_nb_errors(model, test_input, test_target, batch_size)
        test_acc_list.append(1 - (nb/test_input.size(0)))
...
train_model(model, train_input, train_target, batch_size, epochs, test_input, test_target)
